@extends('layouts/app')
@section('content')
    <div class="container-fluid page-body-wrapper full-page-wrapper h-75">
        <div class="content-wrapper d-flex justify-content-top auth px-0">
                <div class="row w-100 mx-0 h-100">
                    <div class="col-lg-6 mx-auto mt-5">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <span style="color: #000000; font-size: 24px;">Telegram-бот <b class="text-info">Webhook</b></span>
                    ...
                    <div class="col-lg-6 mx-auto mt-5">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <span style="color: #000000; font-size: 24px;"><b class="text-info">Ответ</b> на запрос</span>
                            @php
                            if(isset($results)){
